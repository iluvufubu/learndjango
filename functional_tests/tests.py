...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def setUp(self):
        self.browser = webdriver.Chrome(executable_path='C:/Users/sures/Downloads/djangonewproject/chromedriver.exe')
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        #Francis visits home page and there's no sign of Edith's list
        self.browser.get(self.live_server_url)
